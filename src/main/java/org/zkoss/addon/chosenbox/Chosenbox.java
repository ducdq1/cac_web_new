...
public class Chosenbox extends HtmlBasedComponent {
	...
	public String getValue() {
		LinkedHashSet<Object> list = getSelectedObjects();
	...
	public void service(org.zkoss.zk.au.AuRequest request, boolean everError) {
		...
		if (selItems != null && !selItems.isEmpty()) {
			List deSelItems = new ArrayList<>();
			for (Object object : selItems) {
				String deEscapeHTML = StringUtils.deEscapeHtml(object
						.toString());
				deSelItems.add(deEscapeHTML);
			}
			selItems.clear();
			selItems.addAll(deSelItems);
			...
			for (int i = 0; i < selItems.size(); i++) {
				...
				if (idx < _jsel || _jsel == -1)
					_jsel = idx;
                        ...
                        //linhdx commnet de nang cap len ban zk 7.0.3
