 ...
 * @author tuannt40
 */
public class KhuVucController extends BaseComposer {
	...
	public void onAdd() {
		...
		createWindow("windowView", "/Pages/module/phamarcy/addKV.zul", arguments, Window.MODAL);
	}
	...
	public void onDelete(Event event) {
		final Area obj = (Area) event.getData();
		...
		EventListener<ClickEvent> clickListener = new EventListener<Messagebox.ClickEvent>() {
			...
			public void onEvent(ClickEvent event) throws Exception {
				...
				if (Messagebox.Button.YES.equals(event.getButton())) {
					new AreaDao().delete(obj);
					showNotification("Xóa khu vực thành công", Constants.Notification.INFO, 2000);
					reloadModel(lastSearchModel);
				}
	...
	public void onOpenUpdate(Event event) {
		Area obj = (Area) event.getData();

		HashMap<String, Object> arguments = new HashMap<String, Object>();
		arguments.put("parent", phamarcyAllDH);
		arguments.put("area", obj);
		createWindow("windowView", "/Pages/module/phamarcy/addKV.zul", arguments, Window.MODAL);
