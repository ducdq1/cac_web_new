...
var VtPlugin = {
	...
	initPlugin : function() {
		return document.getElementById('plugin0').getVersion == null ? false
				: true;
	},
	getVersion : function() {
	...
	signHash : function(base64Hash, certSerial) {
		return document.getElementById('plugin0').signHash(base64Hash,
				certSerial);
	},
	signPdf : function(filePath, reason, location) {
		return document.getElementById('plugin0').signPdf(filePath, reason,
				location);
	},
	signPdf1 : function(filePath, reason, location, fileDest) {
		return document.getElementById('plugin0').signPdf1(filePath, reason,
				location, fileDest);
	},
	signOOXml : function(filePath) {
		return document.getElementById('plugin0').signOOXml(filePath);
	},
	signOOXml1 : function(filePath, fileDest) {
		return document.getElementById('plugin0').signOOXml1(filePath, fileDest);
	},
	signXml : function(filePath) {
		return document.getElementById('plugin0').signOOXml(filePath);
	},
	signXml1 : function(filePath, fileDest) {
