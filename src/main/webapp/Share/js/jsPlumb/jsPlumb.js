        ...
        this.makeTarget = function(el, params, referenceParams) {
            ...
            var targetScope = p.scope || _currentInstance.Defaults.Scope,
                ...
                var _drop = function() {
                    ...
                    if (scope)
                        this.setDragScope(draggable, scope);
                    ...
                    if (_continue) {
                        ...
                        if (p.uniqueEndpoint)
                            def.endpoint = newEndpoint;  // may of course just store what it just pulled out. that's ok.
                        // TODO test options to makeTarget to see if we should do this?
                        newEndpoint._doNotDeleteOnDetach = false; // reset.
                        newEndpoint._deleteOnDetach = true;
...
// --------------------- end makeSource/makeTarget ---------------------------------------------- 				
        ...
        this.setId = function(el, newId, doNotSetAttribute) {
            ...
            if (this.dragManager)
                this.dragManager.changeId(id, newId);
